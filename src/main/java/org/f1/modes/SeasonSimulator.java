...
//            for( int i = 0; i < RACE_NAMES_2024.size()-6; i++ ) {
...
//            }
        ...
        LinkedHashMap<Double, Double> resultMap = agents.stream().collect(Collectors.toMap(CostCapMultAgent::getCostCapMultiplier, a -> a.getScore() / 10, Double::sum, LinkedHashMap::new));
