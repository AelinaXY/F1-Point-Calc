...
public enum Drivers {
    ...
    COL(new PointEntity("Franco Colapinto", 4.5, 0,0)),
    ...
    NOR(new PointEntity("Lando Norris", 30.4, 41.7,41)),
    HAM(new PointEntity("Lewis Hamilton", 23.6, 16.3,28)),
    LAW(new PointEntity("Liam Lawson", 6, -0.5,4)),
    VER(new PointEntity("Max Verstappen", 28.8, 27.8,32)),
    HUL(new PointEntity("Nico Hulkenberg", 6, 2.5,4.3)),
    BEA(new PointEntity("Oliver Bearman", 8.5, 8.2,10.3)),
    PIA(new PointEntity("Oscar Piastri", 24, 36.7,47)),
