...
public class NSADFactory {
    ...
    public NSADFactory(MERService merService, SessionResultService sessionResultService) {
        this.merService = merService;
        this.sessionResultService = sessionResultService;
    }

    public Optional<NSAD> createLabelled(FullPointEntity fullPointEntity, Meeting meeting) {
    ...
    public NSAD createUnlabelled(FullPointEntity fullPointEntity, Meeting meeting) {
        MeetingEntityReference meetingEntityReference =
                merService.getOrCreateMeetingEntityReference(fullPointEntity.getYear(), meeting, fullPointEntity);
        List<Double> pointHistory = getPointHistory(fullPointEntity, meeting.getShortName());
        return buildBaseNsad(fullPointEntity, meetingEntityReference, pointHistory);
    }
